...
const AppContent: React.FC = () => {
  const { userProfile, alerts, isSignedIn, login, logout, toasts, removeToast } = useFarm();
  ...
  if (!hasStarted) {
    return <GetStarted onStart={() => setHasStarted(true)} />;
  }

  return (
    <div className="flex h-screen bg-[#FDFCF8] dark:bg-slate-950 overflow-hidden relative transition-colors duration-300">
